...
var CreateContactComponent = /** @class */ (function () {
    ...
    CreateContactComponent.prototype.newEmployee = function () {
        this.submitted = false;
    };
    CreateContactComponent.prototype.save = function () {
        ...
        this.contactService.createContact(this.contact)
            ...
            console.log(data);
            _this.contact = new _contact__WEBPACK_IMPORTED_MODULE_1__["Contact"]();
            _this.contacts = _this.contactService.getContactsList();
    ...
    CreateContactComponent.prototype.updateTable = function () {
        this.contacts = this.contactService.getContactsList();
    };
    CreateContactComponent.prototype.deleteContact = function (id) {
        var _this = this;
    ...
    CreateContactComponent.prototype.updateContact = function (contact) {
        this.contact = contact;
        //this.router.navigate(['update', contact]);
    };
    CreateContactComponent.prototype.numberOnly = function (event) {
